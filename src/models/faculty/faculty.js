/**
 * Faculty data model
 * Stores faculty records and provides helper functions
 * for lookup and sorting.
 */

// Faculty data object keyed by facultyId
const faculty = {
  'brother-jack': {
    name: 'Brother Jack',
    office: 'STC 392',
...
/**
 * Look up a faculty member by facultyId
...
/**
 * Return a sorted array of faculty members
 * Valid sort values: name, department, title
 * Defaults to name if invalid.
 * @param {string} sortBy
 * @returns {Array}
 */
const getSortedFaculty = (sortBy) => {
  ...
  const facultyArray = Object.values(faculty);
